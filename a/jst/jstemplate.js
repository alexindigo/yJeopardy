...
JstProcessor.prototype.jstContent_ = function(context, template, content) {
  ...
  if (typeof value == 'undefined' || value === null)
    ...
    value = STRING_empty + value;
  if (template.tagName == 'INPUT')
    this.jstContent_input_(value, template);
  else
    this.jstContent_common_(value, template);
};

// common function for all elements except input
JstProcessor.prototype.jstContent_common_ = function(value, template) {
...
JstProcessor.prototype.jstContent_input_ = function(value, template) {
  // Prevent flicker when refreshing a template and the value doesn't
  // change.
